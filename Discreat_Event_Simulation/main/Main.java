...
public class Main {
	...
	public static void main(String[] args) {
		...
		Simulator.setupSimulation(args[2], processor,eventQueue);
		Simulator.simulate();
		
		processor.printState(0, 30); // ((0, 0) refers to the range of main memory addresses we wish to print. this is an empty set.
		
		Statistics.setNumberOfInstructions(processor.getnInstructions());
		Statistics.setNumberOfCycles(processor.getnCycles());
